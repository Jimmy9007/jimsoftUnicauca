...
CREATE TABLE `archivos` (
  ...
  `idResolucion` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `idEmitido` int(11) UNSIGNED NOT NULL,
  `nombre` text COLLATE utf8_unicode_ci NOT NULL,
  `descripcion` text COLLATE utf8_unicode_ci NOT NULL,
  `tipo` enum('Comunicados','Resoluciones','Circulares','Acuerdos','Convocatorias') COLLATE utf8_unicode_ci NOT NULL,
...
(1, '20230927', 1, 'Proceso de expedición de paz y salvo academico para grados 2 de junio de 2023', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam nec tincidunt dui. Sed eu gravida urna. Nunc feugiat at mi quis tempus. Aenean molestie sapien ut tempus ornare. Donec nisi tellus, pulvinar ac hendrerit vitae, rutrum eget eros. Quisque volutpat felis bibendum tincidunt egestas. Donec semper, metus sed fringilla congue, ante erat ornare leo, in congue metus dui eu massa. Aenean ut urna enim. Curabitur feugiat sed dui in congue. Quisque at suscipit nisl, eget laoreet diam. Nulla semper eget nulla sed sodales. Vestibulum et consectetur libero. Sed eget ligula sed nulla dictum ornare. Mauris interdum eros dui, ut egestas mauris iaculis non. Aliquam aliquet consequat ipsum, et pretium risus mollis sed. Nunc rhoncus, orci sit amet mattis placerat, tellus libero imperdiet mi, ac ullamcorper diam nulla quis urna.', 'Comunicados', '0000-00-00', '0000-00-00', '2023-03-01', 'DOC_65160101c50a66_91572779.pdf', 'Activo', 'jnunez', '', '2023-09-28 17:41:05', '0000-00-00 00:00:00'),
(2, '20231003', 1, 'Tercera convocatoria Monitorias Facultad de Artes - Proyecto de inversión. II Periodo 2023', 'Tercera convocatoria Monitorias Facultad de Artes - Proyecto de inversión. II Periodo 2023', 'Convocatorias', '2023-10-02', '2023-10-06', '2023-10-02', 'DOC_6516cfd4654c47_01517562.pdf', 'Activo', 'jnunez', '', '2023-09-29 08:23:32', '0000-00-00 00:00:00'),
(3, 'R-0228 de 2', 1, 'Resolución R-0228 de 2023 (Adjunta 14 créditos condonables y se declaran 16)', 'Resolución R-0228 de 2023 (Adjunta 14 créditos condonables y se declaran 16)', 'Resoluciones', '0000-00-00', '0000-00-00', '2023-03-01', 'DOC_651b140e6394f4_59205690.pdf', 'Activo', 'jnunez', '', '2023-10-02 14:03:42', '0000-00-00 00:00:00'),
(4, '20231002', 1, 'Circular Informativa de la Facultad de Ciencias Agraria sobre convocatoria a inscripciones y elección de representante profesoral ante el Consejo de la Facultad', 'Circular Informativa de la Facultad de Ciencias Agraria sobre convocatoria a inscripciones y elección de representante profesoral ante el Consejo de la Facultad', 'Circulares', '0000-00-00', '0000-00-00', '2023-09-21', 'DOC_651b18d7655212_70849650.pdf', 'Activo', 'jnunez', '', '2023-10-02 14:24:07', '0000-00-00 00:00:00'),
(5, '20230830', 1, 'Acuerdo Académico 018 de 2023 (Por el cual se modifica el calendario del segundo periodo académico 2023, en cuanto a la aceptación y generación de la liquidación de la matrícula financiera por parte de los estudiantes regulares)', 'Acuerdo Académico 018 de 2023 (Por el cual se modifica el calendario del segundo periodo académico 2023, en cuanto a la aceptación y generación de la liquidación de la matrícula financiera por parte de los estudiantes regulares)', 'Acuerdos', '0000-00-00', '0000-00-00', '2023-08-30', 'DOC_651b1cc7445271_89379059.pdf', 'Activo', 'jnunez', '', '2023-10-02 14:40:55', '0000-00-00 00:00:00'),
(6, ' R - 0955', 1, 'Resolución R - 0955 de 2023 (Por la cual se establece beneficios como incentivos a los trabajadores oficiales activos de la Universidad del Cauca, periodo 2023-2027)', 'Resolución R - 0955 de 2023 (Por la cual se establece beneficios como incentivos a los trabajadores oficiales activos de la Universidad del Cauca, periodo 2023-2027)', 'Resoluciones', '0000-00-00', '0000-00-00', '2023-10-02', 'DOC_651b34841e5806_22347058.pdf', 'Activo', 'jnunez', '', '2023-10-02 16:22:12', '0000-00-00 00:00:00');
...
(5, 'JOSÉ IVÁN', 'NÚÑEZ ASTUDILLO', 'Cedula', '1061744911', '1992-01-21', 'ivancho909090@gmail.com', '3123699193', 'CAR 20A # 2-14 B/PANDIGUANDO', 'Activo', 'Masculino', 'jnunez', '', '2023-09-10 13:58:28', '0000-00-00 00:00:00'),
...
CREATE TABLE `eventos` (
  ...
  `tipo` enum('Periodo academico','Inicio y finalizacion de clases','Planeacion','Tramites academicos','Intersemestrales','Fin periodo academico','Otro') COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `solicitud` (
  ...
  `tipoIdentificacion` enum('Cedula','Tarjeta de Identidad','Pasaporte') COLLATE utf8_unicode_ci NOT NULL,
  `identificacion` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 1, 1, 'Jimmy Andrés Núñez Astudillo', 'jnunez', '$2y$10$PQVWpXJjAS8rGXLlu/JpHOzcHZmXMSjt8BJYOHEHO0AkbL3JwtX2K', 'F0rc3@rmy4lfa', '521AAFCE422405BC074A4A1EB42B9125.jpg', 'Activo', 'Sistema', 'jnunez', '2022-04-11 16:24:29', '2023-09-20 13:15:40'),
(2, 2, 1, 'Cristian Jesús Núñez Astudillo', 'cnunez', '$2y$10$iUOtqzgehXGoMDKfxf.Gl.O5yY0P8aCdk6unsd7A/AdrMIyLSe9ga', '@cnunez#', 'perfilHombre.png', 'Activo', 'jnunez', '', '2023-09-15 22:15:53', '0000-00-00 00:00:00'),
(3, 3, 1, 'RUBIELA ASTUDILLO ESPINOSA', 'rastudillo', '$2y$10$LjKAIcZzYl0js99ZvuxZS.hZHQLIsVob1qNLv/98uS5cy1QhiJZDm', '@rastudillo#', 'perfilMujer.png', 'Activo', 'jnunez', '', '2023-09-15 22:16:32', '0000-00-00 00:00:00'),
(4, 4, 1, 'BEATRIZ EUGENIA CUCUÑAME VALENCIA', 'bcucuname', '$2y$10$1veuTlGIM7XfV/4UW/nDOOLN2G20VU4XCYCgwif.MdAX.w9cnRVRu', '@bcucuname#', 'perfilMujer.png', 'Activo', 'jnunez', '', '2023-09-15 22:17:14', '0000-00-00 00:00:00'),
(5, 5, 1, 'JOSÉ IVÁN NÚÑEZ ASTUDILLO', 'jnunez474', '$2y$10$LRQ1P7MlLj.XF1.g7MC/J.997/kvZJ6vdnS56fOk15VAOZXpeoOnK', '@jnunez474#', 'perfilHombre.png', 'Activo', 'jnunez', '', '2023-09-15 22:17:37', '0000-00-00 00:00:00');
...
--
ALTER TABLE `archivos`
  MODIFY `idArchivo` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
