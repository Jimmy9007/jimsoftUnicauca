...
class ArchivoDAO extends AbstractTableGateway
{
    ...
    {
        return new Archivo($this->select(array('idArchivo' => $idEmpleado))->current()->getArrayCopy());
    }
    //------------------------------------------------------------------------------
    ...
    public function editar(Archivo $archivoOBJ = null)
    {
        try {
            $this->table = 'archivos';
            $idEmpleado = (int) $archivoOBJ->getIdEmpleadoCliente();
            $update = new Update($this->table);
            $datos = $archivoOBJ->getArrayCopy();
            $update->set($datos);
            $update->where("archivos.idArchivo =  $idEmpleado");
    ...
    public function eliminar(Archivo $archivoOBJ = null)
    {
        try {
            ...
            $update->where("archivos.idArchivo = " . $archivoOBJ->getIdEmpleadoCliente());
            //echo $update->getSqlString();
