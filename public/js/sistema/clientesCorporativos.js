...
function verRegistrar() {
    $.ajax({
        ...
        success: function (html) {
            ...
            $("#atrasForm").hide();
            $('#lbModalFormulario').html('Registro de Cliente Corporativo');
...
function verDetalle(idCliente) {
    $.ajax({
        ...
        success: function (html) {
            $("#divContenido").html(html);
            $("#atrasForm").hide();
            $('#lbModalFormulario').html('Detalle del Cliente Corporativo');
            $('#modalFormulario').modal('show');
            localStorage.clear();
            refEditar();
        }
...
function verEditar(idCliente) {
    $.ajax({
        ...
        success: function (html) {
            $("#divContenido").html(html);
            $("#atrasForm").hide();
            $('#lbModalFormulario').html('Actualizacion de Cliente Corporativo');
            $('#modalFormulario').modal('show');
            localStorage.clear();
            refEditar();
        }
